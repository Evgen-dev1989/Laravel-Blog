...
<select class="form-control" name="published">
    @if (isset($article->id))
        <option value="0" @if ($articley->published == 0) selected="" @endif>Не опубликовано</option>
...
<input type="text" class="form-control" name="meta_description" placeholder="Мета описаниек" value="{{$article->meta_description ?? ""}}" required>
